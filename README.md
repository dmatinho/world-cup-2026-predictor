...
**Live demo:** enable GitHub Pages on this repo (Settings → Pages → Deploy from branch → main, root) and it's served at https://dmatinho.github.io/world-cup-2026-predictor/.
